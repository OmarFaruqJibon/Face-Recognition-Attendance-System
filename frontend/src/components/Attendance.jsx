            ...
            {loading ? (
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {attendance.map((row, i) => {
                        const entryTime = row.first_seen
                            ? new Date(row.first_seen).toLocaleTimeString()
                            : "-";
                        const exitTime = row.last_seen
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex justify-between mb-2">
                                    ...
                                    <span className="text-xs bg-green-100 text-green-700 px-2.5 py-1 rounded-full font-medium">{formatDuration(row.total_duration_seconds)}</span>
                                ...
                                <div className="flex justify-between">
                                    <p className="text-gray-700 text-sm">
                                        <span className="font-medium text-gray-800">Entry: </span>
                                        {entryTime}
                                    </p>
                                    <p className="text-gray-700 text-sm">
                                        <span className="font-medium text-gray-800">Exit: </span>
                                        {exitTime}
                                    </p>
                                </div>
